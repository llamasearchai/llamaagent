...
class BaseTool(ABC):
    ...
    def __init__(
        ...
        self.description = description or self.__class__.__doc__ or "No description provided"
    ...
    def run(self, *args: Any, **kwargs: Any) -> ToolResult:
        ...
        while attempt < self.max_attempts:
            ...
            try:
                ...
                logger.info(f"Tool {self.name} completed successfully in {attempt} attempts")
                return tool_result
                
            except Exception as e:
                last_error = str(e)
                logger.warning(f"Tool {self.name} failed on attempt {attempt}/{self.max_attempts}: {e}")
