...
class LLMConfig:
    ...
    extra_params: Dict[str, Any] = field(default_factory=dict)  # Additional parameters for the provider
...
class MemoryConfig:
    ...
    embedding_model: str = "sentence-transformers/all-MiniLM-L6-v2"  # Model for embeddings
