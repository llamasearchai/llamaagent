...
class AnthropicClient(LLMClient):
    ...
    def generate_with_json(self, prompt: str, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"error": "Could not parse JSON from response", "text": response_text}
...
class OpenAIClient(LLMClient):
    ...
    def generate_with_json(self, prompt: str, **kwargs) -> Dict[str, Any]:
        ...
        if "response_format" not in kwargs and "response_format" not in self.config.extra_params:
