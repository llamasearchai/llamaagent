...
async def demo_basic_agent():
    ...
    try:
        ...
        # Create basic agent
        config = AgentConfig(name="DemoAgent", role=AgentRole.GENERALIST, temperature=0.7, spree_enabled=False)
        ...
        # Test tasks
        test_tasks = ["What is 15 * 23?", "Calculate the square root of 144", "What is the capital of France?"]
...
async def demo_spre_planning():
    ...
    try:
        ...
        complex_task = (
            "Calculate compound interest on $1000 at 5% for 3 years, then create a Python function for this calculation"
        )
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            chat_response = client.post(
                "/chat", json={"message": "What is 2 + 2?", "temperature": 0.7, "spree_enabled": False}
            )
