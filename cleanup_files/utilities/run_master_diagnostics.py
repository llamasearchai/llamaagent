...
try:
    ...
    def main():
        ...
        try:
            ...
            critical_issues = [
                p for p in report.problems if p.severity.value == "CRITICAL"
            ]
            if critical_issues:
            ...
            critical_count = (
                severity_counts.get("CRITICAL", 0) if severity_counts else 0
            )
        ...
        for py_file in python_files:
            try:
                ...
                critical_issues.append(
                    f"Syntax error in {py_file.relative_to(project_root)}: {se}"
                )
