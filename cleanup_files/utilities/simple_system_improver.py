...
def main() -> bool:
    ...
    improvements: List[Tuple[str, str]] = [
        ...
        (
            "python -c \"import llamaagent; print('Package import successful')\"",
            "Test package import",
        ),
        (
            "python -c \"from src.llamaagent.api.main import app; print('API import successful')\"",
            "Test API import",
        ),
        (
            "python -c \"from src.llamaagent.llm.factory import LLMFactory; print('LLM Factory working')\"",
            "Test LLM Factory",
        ),
    ]
