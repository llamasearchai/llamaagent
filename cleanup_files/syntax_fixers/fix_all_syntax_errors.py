...
logging.basicConfig(
    ...
    handlers=[logging.StreamHandler(), logging.FileHandler('syntax_fixes.log')],
)
...
class SyntaxErrorFixer:
        ...
        for line in lines:
            ...
            if any(
                ...
                for pattern in [
                    ...
                    'for, in,',
                    'len, metric',
                    'self._calculate_dissent_ratio,',
                    'self._calculate_plan_quality,',
    ...
    def fix_all_syntax_errors(self) -> Dict[str, Any]:
        ...
        summary = {
            ...
            "errors": self.errors,
            "success_rate": (files_fixed / files_with_errors * 100)
            if files_with_errors > 0
            else 100,
        }

        logger.info(
            f"Syntax fix summary: {files_fixed}/{files_with_errors} files fixed"
        )
        return summary
