...
async def get_metrics():
    ...
    try:
        ...
        return {
            ...
            "available_tools": len(app_state.get("tools", {}).list_tools() if app_state.get("tools") else []),
...
async def analyze_image(
    ...
    query: str = Body(default="Analyze this image in detail", embed=True, description="Analysis query"),
