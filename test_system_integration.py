...
from llamaagent.data.gdt import GDTGenerator, GDTDataset, GDTItem, DataType
...
class SystemIntegrationTest:
    ...
    def test_imports(self):
        ...
        try:
            ...
            from llamaagent.storage.database import DatabaseManager, DatabaseConfig, QueryResult
            
            # Test GDT imports
            from llamaagent.data.gdt import (
                GDTGenerator, GDTDataset, GDTItem, DataType, 
                ValidationStatus, GDTValidator, GDTTransformer
            )
    ...
    def test_database_config(self):
        ...
        try:
            ...
            self.log_test("Database Config Test", True, "Database configuration working correctly")
            return True
        except Exception as e:
    ...
    def test_database_manager_initialization(self):
        ...
        try:
            ...
            self.log_test("Database Manager Init Test", True, "Database manager initialized correctly")
            return True
        except Exception as e:
            self.log_test("Database Manager Init Test", False, f"Initialization failed: {e}")
            return False
    ...
    def test_gdt_generator_initialization(self):
        ...
        try:
            ...
            self.log_test("GDT Generator Init Test", True, "GDT generator initialized correctly")
            return True
        except Exception as e:
            self.log_test("GDT Generator Init Test", False, f"GDT initialization failed: {e}")
            return False
    ...
    def test_gdt_item_creation(self):
        ...
        try:
            ...
            self.log_test("GDT Item Creation Test", True, "GDT items created and serialized correctly")
            return True
        except Exception as e:
    ...
    def test_gdt_dataset_operations(self):
        ...
        try:
            ...
            self.log_test("GDT Dataset Operations Test", True, "Dataset operations working correctly")
            return True
        except Exception as e:
            self.log_test("GDT Dataset Operations Test", False, f"Dataset operations failed: {e}")
            return False
    ...
    def test_gdt_validation(self):
        ...
        try:
            ...
            valid_item = GDTItem(
                data_type=DataType.TEXT,
                content={"text": "This is a valid test content with sufficient length."},
                tags=["valid", "test"]
            )
            ...
            self.log_test("GDT Validation Test", True, "Validation system working correctly")
            return True
        except Exception as e:
    ...
    def test_gdt_transformation(self):
        ...
        try:
            ...
            transformed_item = transformer.transform_item(item, "add_metadata", test_key="test_value")
            assert transformed_item.metadata["test_key"] == "test_value"
            
            self.log_test("GDT Transformation Test", True, "Transformation system working correctly")
            return True
        except Exception as e:
            self.log_test("GDT Transformation Test", False, f"Transformation failed: {e}")
            return False
    ...
    def test_gdt_generation(self):
        ...
        try:
            ...
            self.log_test("GDT Generation Test", True, "Data generation working correctly")
            return True
        except Exception as e:
    ...
    def test_json_serialization(self):
        ...
        try:
            ...
            self.log_test("JSON Serialization Test", True, "JSON serialization working correctly")
            return True
        except Exception as e:
            self.log_test("JSON Serialization Test", False, f"JSON serialization failed: {e}")
            return False
    ...
    def test_error_handling(self):
        ...
        try:
            ...
            try:
                self.gdt_generator.transformer.transform_item(item, "invalid_transformation")
                assert False, "Should have raised an error"
            except ValueError:
                pass  # Expected
            ...
            self.log_test("Error Handling Test", True, "Error handling working correctly")
            return True
        except Exception as e:
...
def main():
    ...
    with open("test_results.json", "w") as f:
        json.dump({
            ...
            "passed": sum(1 for r in test_suite.test_results if r["status"] == "PASS"),
            "failed": sum(1 for r in test_suite.test_results if r["status"] == "FAIL"),
