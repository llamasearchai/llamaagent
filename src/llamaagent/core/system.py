...
class AgentSystem(BaseModel):
    ...
    def run(self, task: str, **kwargs) -> AgentSystemResult:
        ...
        try:
            ...
            logger.info(f"Agent system {self.name} completed task in {execution_time:.2f}s")
    ...
    def _run_round_robin(self, task: str, agent_results: List[AgentResult], max_iterations: int = 5, **kwargs) -> str:
        """
    ...
    def _run_sequential(self, task: str, agent_results: List[AgentResult], **kwargs) -> str:
        """
    ...
    def _run_parallel(self, task: str, agent_results: List[AgentResult], **kwargs) -> str:
        """
    ...
    def _run_hierarchical(self, task: str, agent_results: List[AgentResult], **kwargs) -> str:
        """
