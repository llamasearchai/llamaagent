...
class CodeGenerator:
    ...
    def _detect_language(self, prompt: str) -> ProgrammingLanguage:
        ...
        language_indicators = {
            ProgrammingLanguage.PYTHON: ["python", "py", "django", "flask", "pandas", "numpy"],
            ProgrammingLanguage.JAVASCRIPT: ["javascript", "js", "node", "react", "vue", "angular"],
...
async def main() -> None:
    ...
    request = CodeGenerationRequest(
        ...
        style="production",
        context={"requirements": ["Handle edge cases", "Include type hints", "Add docstring"]}
    )
