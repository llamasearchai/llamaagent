#!/usr/bin/env python3
"""
Production FastAPI Application for LlamaAgent
...
async def lifespan(app: FastAPI):
    ...
    # Startup
    logger.info("Starting LlamaAgent FastAPI Server")
...
async def health_check():
    ...
    return HealthCheckResponse(
        ...
        version="1.0.0",
        database_connected=db_manager is not None and db_manager._initialised,
